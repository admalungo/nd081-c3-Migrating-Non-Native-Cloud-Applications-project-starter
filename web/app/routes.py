...
def notification():
    if request.method == 'POST':
        ...
        try:
            ...
            db.session.commit()
            # print("********ITEM SAVED TO PSQL DB ON LOCALHOST********")
            ...
            for attendee in attendees:
                ...
                logging.info(attendee.first_name)
                print("********ATTENDEE FIRST NAME: {}********".format(attendee.first_name))

            notification.completed_date = datetime.utcnow()
            notification.status = 'Notified {} attendees'.format(len(attendees))
            print("********ATTENDEES: {}********".format(len(attendees)))
            db.session.commit() """
